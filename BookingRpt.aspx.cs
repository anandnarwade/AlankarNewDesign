...
namespace AlankarNewDesign
{
    public partial class BookingRpt : System.Web.UI.Page
    {
        ...
        public void _fillGrid(string Qry, GridView GridName)
        {
            ...
            // generic.ExportToFolder(GridName, _filePath, "Booking");
            //string _AttacheFilePathForB = Server.MapPath("/Export/Booking.xls");
            //generic._sentEmailWithAttachment("", "anand.narwade11@gmail.com", _AttacheFilePathForB);
        ...
        protected void btnExportBooking_Click(object sender, EventArgs e)
        {
            string _filePath = Server.MapPath("~/Export/");
