<%@ Page Title="" Language="C#" MasterPageFile="~/alankarTheme.Master" AutoEventWireup="true" CodeBehind="tool_dim_config.aspx.cs" Inherits="AlankarNewDesign.tool_dim_config" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="padding-top:5px;">
          <fieldset class="scheduler-border"  style="border:1px solid #5789b3; margin-right:0px; ">
                ...
                <div class="row" style="margin-left: 30px; margin-right: 30px; padding-bottom:0px; ">
                  <%--  <div class="row" style="padding-top:20px; padding-left:20px;"><b style="font-size:13px;">RAW MATERIAL</b></div>--%>
                    <div class="row" style="padding-left:20px; padding-right:20px;  padding-bottom:10px; width:1080px;">
...
<HeaderStyle Font-Bold="False"></HeaderStyle>
                         ...
                         <asp:TemplateField HeaderText="ACTION" HeaderStyle-Font-Bold="false">
                            <ItemTemplate>
                                            ...
                                            <asp:LinkButton Font-Size="11px" ID="lnkDelete" CommandArgument= '<%#Eval("ID") %>' OnClick="lnkDelete_Click"   runat="server" ToolTip="Click To Delete" ForeColor="Red"><i class="glyphicon glyphicon-trash"></i></asp:LinkButton>  
