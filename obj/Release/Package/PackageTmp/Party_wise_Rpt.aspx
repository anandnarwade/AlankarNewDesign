...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="padding-top:10px; padding-left:20px; padding-left:20px; overflow-x:auto; overflow-wrap:break-word;">
        <asp:GridView Font-Size="11px" ID="GridParty" AutoGenerateColumns="false" CssClass="GridView1 table table-bordered table-hover table-responsive dataTable no-footer dtr-inline" runat="server">
            <Columns>
